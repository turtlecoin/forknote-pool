...
var addressBanning = config.poolServer.banning && config.poolServer.banning.addressbanning;
...
function IsBannedAddress(address){
	if (!addressBanning || !bannedAddress[address]) return false;
